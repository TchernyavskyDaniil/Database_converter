# coding: utf-8
from common import minidom_fixed as dom
...
class RamToXdb:
    ...
    def __generate_indexes(self, table):
        ...
        for index in table.indexes:
            ...
            if is_not_empty(index.uniqueness) and index.uniqueness:
                current_index.setAttribute('props', 'uniqueness')

            if is_not_empty(index.fulltext) and index.fulltext:
                if current_index.getAttribute('props'):
                    current_index.setAttribute(current_index.getAttribute('props') + "," + 'fulltext')
                else:
